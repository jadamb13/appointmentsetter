...
A `login_activity.txt` file is located in the `src` directory and Javadoc documentation files are 
located in the `javadocs` directory within the `src` directory.
